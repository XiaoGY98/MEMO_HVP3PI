...
\begin{table}[t]
    \begin{center}
        \caption{Optimized unfolding parameters for the three representative mass regions, determined using the Round~16 MC sample. The $\chi^2/\text{ndf}$ values are shown for all four rounds to demonstrate the consistency of the unfolding performance across different data-taking conditions.}
        \vspace{4mm}
