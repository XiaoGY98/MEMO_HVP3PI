...
\label{sec:sample}
We use an $\ee$ collision sample corresponding to an integrated luminosity of 20 $\ifb$, collected with the BESIII detector at a center-of-mass energy of 3.773 $\gev$, reconstucted under BOSS-7.1.2 version. The details are listed in Table~\ref{tab:datalumi}, quoted from Refs.~\cite{BESIII_lumi0304, BESIII_lumi_2024}.
