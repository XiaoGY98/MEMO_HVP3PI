...
result shown in Fig.~\ref{fig:chisq_optimization}. The Round 16 optimization
yields an optimal cut of $\chi^{2}_{\mathrm{KF}} < 50$.
...
Fig.~\ref{fig:mass_spectra_regions}.The $e^{+}e^{-} \to
...
Fig.~\ref{fig:4pi_background_spectrum}.

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.45\textwidth]{fig/4pi_3pi_mass.eps}
...
regions are presented in Fig.~\ref{fig:nonisr4pi_all_regions}. All other
...
\begin{figure}[htbp]
    \centering
    \subfloat[$\omega(782)$ region]{
        \includegraphics[width=0.32\textwidth]{fig/nonisr4pi_region1_plot.eps}
    }
    \hfill
    \subfloat[$\phi(1020)$ region]{
        \includegraphics[width=0.32\textwidth]{fig/nonisr4pi_region2_plot.eps}
    }
    \hfill
    \subfloat[$\omega^{\prime}$ and $\omega^{\prime\prime}$ region]{
        \includegraphics[width=0.32\textwidth]{fig/nonisr4pi_region3_plot.eps}
    }
    ...
    \label{fig:nonisr4pi_all_regions}
\end{figure}
...
\begin{itemize}
    \item \textbf{Signal PDF:} Histogram shape from signal MC, convolved with a Gaussian for resolution correction.
...
\caption{Typical $U_{\text{miss}}$ fit results for representative $M_{3\pi}$ bins from each of the three mass regions. The data points are shown with error bars, the solid blue curve represents the total fit PDF, the red dashed curve shows the signal component, the green shaded area indicates the peaking background from $\pi^{+}\pi^{-}\pi^{0}\pi^{0}$, and the magenta dashed line represents the polynomial continuum background.}
\label{fig:fit_examples}
\end{figure}

Applying this fitting procedure to all $M_{3\pi}$ bins yields the extracted signal yields across the entire mass spectrum. Figure~\ref{fig:signal_yields} shows the measured signal yields as a function of $M_{3\pi}$ for the three regions. The $\omega(782)$ resonance is clearly visible as a prominent peak around $0.78~\text{GeV}/c^{2}$, while the $\phi(1020)$ resonance appears as a distinct but smaller peak near $1.02~\text{GeV}/c^{2}$. In the higher mass region, broad structures corresponding to the $\omega^{\prime}$ and $\omega^{\prime\prime}$ excitations are observed, with significantly reduced yields due to the decreasing cross section and lower ISR photon probability at larger momentum transfers.

\begin{figure}[htbp]
\centering
\subfloat[$\omega(782)$ region]{
\includegraphics[width=0.32\textwidth]{fig/yields_omega.eps}
\label{fig:yields_omega}
}
\hfill
\subfloat[$\phi(1020)$ region]{
\includegraphics[width=0.32\textwidth]{fig/yields_phi.eps}
\label{fig:yields_phi}
}
\hfill
\subfloat[$\omega^{\prime}/\omega^{\prime\prime}$ region]{
\includegraphics[width=0.32\textwidth]{fig/yields_high.eps}
\label{fig:yields_high}
}
\caption{Extracted signal yields as a function of $M_{3\pi}$ for the three mass regions. The error bars represent the statistical uncertainties from the fits. The $\omega(782)$ and $\phi(1020)$ resonances appear as clear peaks, while the higher-mass region reveals broader structures corresponding to excited $\omega$ states.}
